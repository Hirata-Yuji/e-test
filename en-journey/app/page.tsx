...
const SERVICES = [
  { num: '01', titleKey: 'svc1_title', bodyKey: 'svc1_body', href: '/service#domestic', img: '/e-test/images/domestic.png', alt: '国内旅行', tag: 'DOMESTIC' },
  { num: '02', titleKey: 'svc2_title', bodyKey: 'svc2_body', href: '/service#overseas', img: '/e-test/images/overseas.png', alt: '海外旅行', tag: 'OVERSEAS' },
  { num: '03', titleKey: 'svc3_title', bodyKey: 'svc3_body', href: '/service#inbound',  img: '/e-test/images/inbound.png',  alt: 'インバウンド', tag: 'INBOUND' },
  { num: '04', titleKey: 'svc4_title', bodyKey: 'svc4_body', href: '/service#landop',   img: '/e-test/images/landop.png',   alt: 'ランドオペレーター', tag: 'LAND OP' },
]
    ...
    <>
            ...
            <AnimateIn direction="right" delay={0.2}>
              <div className="relative h-[460px]">
                ...
                <div className="absolute top-0 left-8 right-0 h-80 overflow-hidden shadow-2xl">
                  <img src="/e-test/images/about.png" alt="南紀白浜の海岸"
                ...
                <div className="absolute bottom-0 left-0 w-52 h-44 overflow-hidden shadow-xl border-4 border-white">
                  <img src="/e-test/images/domestic.png" alt="日本の自然"
                    className="w-full h-full object-cover object-center" />
                </div>
                {/* Badge */}
      ...
      <section className="relative py-40 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img src="/e-test/images/hero.png" alt="" className="w-full h-full object-cover object-[50%_40%]" />
