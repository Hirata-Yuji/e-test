          ...
          <div className="px-6 md:px-12 lg:px-24 max-w-screen-xl mx-auto">
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center
              ...
              <AnimateIn direction={i % 2 === 0 ? 'left' : 'right'}>
                <div className={`aspect-[4/3] rounded-sm bg-gradient-to-br ${s.color}
                                flex items-center justify-center text-8xl relative overflow-hidden`}>
                  <span className="opacity-50">{s.emoji}</span>
                  <div className="absolute top-6 left-6">
                    <span className="text-white/20 font-sans text-6xl font-light">{s.num}</span>
                  </div>
                </div>
              </AnimateIn>
